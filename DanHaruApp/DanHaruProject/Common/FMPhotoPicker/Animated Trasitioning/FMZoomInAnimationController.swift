...
class FMZoomInAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let originalSnapshotSize = snapshot.frame.size.width < HelperPhoto.minimumCellSize ? CGSize(width: HelperPhoto.cellMaxSize, height: HelperPhoto.cellMaxSize) : snapshot.frame.size
